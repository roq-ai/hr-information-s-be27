  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience HR Information System - Empowering Employers to Seamlessly Manage Employee Data, Vacations, and Payroll All in One Place"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience HR Information System - Empowering Employers to Seamlessly Manage Employee Data, Vacations, and Payroll All in One Place`}
            </Text>
            <Box
